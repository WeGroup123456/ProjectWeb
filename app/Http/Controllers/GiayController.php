...
class GiayController extends Controller
{
    ...
    public function postSuaChiTiet(Request $request,$idMauGiay){
        $this->validate($request,
            [
                //'MaGiay' => 'required',
                'Mau' => 'required',
                ...
                'GiaCu.required' => 'Bạn chưa nhập giá cũ',
                'GiaMoi.required' => 'Bạn chưa nhập giá mới',
            ]);
        ...
        return redirect('admin/giay/suachitiet/'.$idMauGiay)->with('thongbao','Sửa thành công');
    }
    ...
    public function getThemSize($id){
        $maugiay = MauGiay::find($id);
        return view('admin.giay.themsize',['maugiay'=>$maugiay]);
    }

    public function postThemSize(Request $request,$id){
        $this->validate($request,
            [
                'Size' => 'required',
                'SoLuong' => 'required',
        ...
        return redirect('admin/giay/themsize/'.$id)->with('thongbao','Thêm thành công');
    }
}
